...
class RegressionModel(object):
    ...
    def run(self, x):
        ...
        return nn.AddBias(nn.Linear(h3, self.w4), self.b4)
    ...
    def train(self, dataset):
        ...
        while True:
            ...
            for x,y in dataset.iterate_once(data_len):
                loss = self.get_loss(x, y)
                if nn.as_scalar(loss) < self.thresh:
                    reached_thresh = True
...
class DigitClassificationModel(object):
    ...
    def __init__(self):
        ...
        self.b1 = nn.Parameter(1,128)
        self.w2 = nn.Parameter(128,256)
        self.b2 = nn.Parameter(1,256)
        self.w3 = nn.Parameter(256,128)
        self.b3 = nn.Parameter(1,128)
        self.w4 = nn.Parameter(128,64)
        self.b4 = nn.Parameter(1,64)
        self.w5 = nn.Parameter(64,32)
        self.b5 = nn.Parameter(1,32)
        self.w6 = nn.Parameter(32,10)
        self.b6 = nn.Parameter(1,10)
    ...
    def run(self, x):
        ...
        h5 = nn.ReLU(nn.AddBias(nn.Linear(h4, self.w5), self.b5))
        return nn.AddBias(nn.Linear(h5, self.w6), self.b6)
    ...
    def train(self, dataset):
        ...
        while True:
            ...
            self.learning_rate = self.learning_rate*0.8 if self.learning_rate > 0.01 else 0.01
            
            reached_thresh = False
            if dataset.get_validation_accuracy() > self.thresh:
                reached_thresh = True
